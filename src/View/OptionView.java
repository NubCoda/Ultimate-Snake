...
/**
 * Klasse für den Dialog der Einstellungen des Spiels.
 */
...
public class OptionView extends JDialog implements ActionListener {
	 ...
	 * 
	 * @param playerVector
	 *            Vektor mit den Spieler, welche ausgewählt werden können
	 * @param difficulty
	...
	/**
	 * Methode zum Initialisieren der GUI-Komponenten für den Options-Dialog
	 */
	...
	/**
	 * Fügt Spielernamen in die Combobox ein, um die Auswahl eines Spielers im
	...
	/**
	 * Wählt den RadioButton des aktuellen Schwierigkeitsgrades vor aus
	 * 
	 * @param difficulty
	...
	public void actionPerformed(ActionEvent arg0) {
		/*
		 * Cancel und Okay (bzw. save) buttons zur Übername der Einstellungen
		 * oder zum Beenden des Optionsmenüs
		 */
	...
	/**
	 * Schließt das Fenster beim Klicken des Cancel-Buttons
	 * 
	 * @param arg0
	 *            Das ActionEvent-Objekt, welche alle Infos über das Klick-Event
	 *            beinhaltet.
	 */
	...
	/**
	 * Setzt die angewählten Einstellungen des Optionsfensters und schreibt
	...
	/**
	 * Speichert die Nummer der Taste für die "rechts"-Taste beim Klicken einer
	...
	/**
	 * Speichert die Nummer der Taste für die "links"-Taste beim Klicken einer
	 * Taste im passenden Textfeld zwischen.
	 * 
	 * @param arg0
	 *            Das ActionEvent-Objekt, welche alle Infos über das Klick-Event
	...
	/**
	 * Speichert die Nummer der Taste für die "hoch"-Taste beim Klicken einer
	 * Taste im passenden Textfeld zwischen.
	 * 
	 * @param arg0
	 *            Das ActionEvent-Objekt, welche alle Infos über das Klick-Event
	...
	/**
	 * Speichert die Nummer der Taste für die "runter"-Taste beim Klicken einer
	 * Taste im passenden Textfeld zwischen.
	 * 
	 * @param arg0
	 *            Das ActionEvent-Objekt, welche alle Infos über das Klick-Event
	...
	/**
	 * Speichert die Nummer der Taste für die "schießen"-Taste beim Klicken
