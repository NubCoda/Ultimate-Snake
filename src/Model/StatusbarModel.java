...
public class StatusbarModel extends Observable {
	...
	public StatusbarModel(PlayerHighscore playerHighscore, GameSettings gameSettings) {
	...
	public void repaintElements() {
		statusLabelVector.elementAt(0).setText("Spieler: " + playerHighscore.getPlayer().getPlayerName());
		statusLabelVector.elementAt(1).setText("Aktueller Score: " + playerHighscore.getCurrentScore());
		statusLabelVector.elementAt(2).setText("Highscore: " + playerHighscore.getHighscore());
		statusLabelVector.elementAt(3).setText("Schwierigkeit: " + gameSettings.getDifficulty());
	}
}
